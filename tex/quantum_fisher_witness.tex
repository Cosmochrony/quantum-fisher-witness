...
\begin{figure}[t]
\centering
\includegraphics[width=0.92\textwidth]{qfi_edge_dos.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.99\textwidth]{heis_full_edge_dos.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.99\textwidth]{qfi_refine.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.92\textwidth]{thermal_closure.pdf}
...
S_i=\frac{1}{c_\chi^2}\sum_{j\sim i}(\phi_i-\phi_j)^2,
\label{eq:biflow}
\end{equation}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.99\textwidth]{bi_extend.pdf}
